...
export const PagesRoutes: Routes = [
  ...
  { path:'NuevoAcreedor', component:FormAcreedorComponent, canActivate: [AutenticacionGuard]},
  { path:'EditarAcreedor/:id', component:FormAcreedorComponent, canActivate: [AutenticacionGuard]},
