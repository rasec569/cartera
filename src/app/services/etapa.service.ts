...
export class EtapaService {
  ...
  public getEtapasProyecto(proyectoid: any): Observable<any> {
    HttpOptionsBody.body.id=proyectoid;
    return this.http.get(`${environment.url}/etapa/proyecto/${proyectoid}`,HttpOptionsBody).pipe(
      tap((result: any) => {
      }),
